function attachEvents() {
    ...
    let locationInfoRef = document.getElementById("location");
    ...
    async function getWeather(event) {
        try {
            let userInput = locationInfoRef.value;
    ...
    function generateSpan(classContainer, classSpan, name, data) {
        ...
        degree.innerHTML = `${data.low + "&#176"}/${data.high + "&#176"}`;
